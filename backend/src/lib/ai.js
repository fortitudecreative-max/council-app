hconst Anthropic = require('@anthropic-ai/sdk');
...
async function callGemini(messages, systemPrompt) {
  ...
  const res = await fetch(
    `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=${process.env.GEMINI_API_KEY}`,h
    {
      method: 'POST',
